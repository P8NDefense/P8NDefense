...
function ContactForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            window.location.href = `mailto:${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["siteConfig"].email}?subject=${subject}&body=${bodyText}`;
            setStatus('idle');
        }
    };
    if (status === 'success') {
...
_s(ContactForm, "fcJ51dE4QhqfhAyXLbez+v79jz4=");
_c = ContactForm;
var _c;
...
//# sourceMappingURL=_0faqmuz._.js.map